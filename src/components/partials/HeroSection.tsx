  ...
  return (
    <div className="hero relative -mt-16 flex items-center justify-center">
      ...
      <div className="flex flex-col items-center">
        ...
        <h1 className="mt-4 text-3xl font-bold ">Sanzida Tasnim</h1>
        ...
        <div className="mt-4 flex gap-5">
          <Link href="https://www.facebook.com/sanzida.tasnim007/">
            <a className="text-gray-700 transition-colors duration-150 hover:text-primary-500">
              <FiFacebook size={25} />
            </a>
          </Link>
          <Link href="https://www.linkedin.com/in/sanzida-tasnim/">
            <a className="text-gray-700 transition-colors duration-150 hover:text-primary-500">
              <FiLinkedin size={25} />
            </a>
          </Link>
          <Link href="https://github.com/SanzidaTasnim">
            <a className="text-gray-700 transition-colors duration-150 hover:text-primary-500">
              <FiGithub size={25} />
            </a>
          </Link>
